export const Abilities: {[abilityid: string]: AbilityData} = {
	...
	darkhumor: {
		desc: "This Pokémon's Dark-type moves become Poison-type moves and have their power multiplied by 1.2. Thí efect comes after other effects that change a move's type."
		shortDesc: "This Pokémon's Dark-type moves become Poison-type and have 1.2x power.",
		onModifyTypePriority: -1,
		onModifyType(move, pokemon) {
			const noModifyType = [
				'judgment', 'multiattack', 'naturalgift', 'revelationdance', 'technoblast', 'terrainpulse', 'weatherball',
